        ...
        <div class="px-12 mx-auto max-w-7xl">
            <div class="w-full mx-auto text-left md:w-11/12 xl:w-9/12 md:text-center">
                <h1 class="mb-8 text-4xl font-extrabold leading-none tracking-normal text-gray-900 md:text-6xl md:tracking-tight">
                    <span class="">Start</span> <span class="block w-full py-2 text-transparent bg-clip-text leading-12 bg-gradient-to-r from-indigo-600 to-purple-500 lg:inline">building a buzz</span> <span>around your product 🚀</span>
                </h1>
                ...
                <div class="mb-4 space-x-0 md:space-x-2 md:mb-8">
                    <a href="#_" class="inline-flex items-center justify-center w-full px-6 py-3 mb-2 text-lg text-white bg-indigo-600 sm:w-auto sm:mb-0 rounded-xl">
                        Get Started
            ...
            <div class="w-full mx-auto mt-20 text-center md:w-10/12">
                <div class="relative z-0 w-full mt-8">
                    <div class="relative overflow-hidden shadow-2xl">
                        <div class="flex items-center flex-none px-4 bg-indigo-600 rounded-b-none h-11 rounded-xl">
                        ...
                        <img src="https://cdn.devdojo.com/images/march2021/green-dashboard.jpg" class="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="flex flex-col px-8 mx-auto space-y-12 max-w-7xl xl:px-12">
            ...
            <div class="flex flex-col mb-8 animated fadeIn sm:flex-row">
                <div class="flex items-center mb-8 sm:w-1/2 md:w-5/12 sm:order-last">
                    <img class="shadow-xl rounded-xl" src="https://cdn.devdojo.com/images/december2020/dashboard-011.png" alt="">
                </div>
            ...
            <div class="flex flex-col mb-8 animated fadeIn sm:flex-row">
                <div class="flex items-center mb-8 sm:w-1/2 md:w-5/12">
                    <img class="shadow-xl rounded-xl" src="https://cdn.devdojo.com/images/december2020/dashboard-04.png" alt="">
                </div>
            ...
            <div class="flex flex-col mb-8 animated fadeIn sm:flex-row">
                <div class="flex items-center mb-8 sm:w-1/2 md:w-5/12 sm:order-last">
                    <img class="shadow-xl rounded-xl" src="https://cdn.devdojo.com/images/december2020/dashboard-03.png" alt="">
                </div>
                <div class="flex flex-col justify-center mt-5 mb-8 md:mt-0 sm:w-1/2 md:w-7/12 sm:pr-16">
    ...
    <section class="bg-white">
        <div class="flex flex-col items-center justify-center px-5 py-20 mx-auto max-w-7xl md:px-0">
            ...
            <div class="flex flex-col justify-center w-full mt-5 space-y-3 sm:space-x-3 sm:space-y-0 sm:flex-row lg:mt-8">
                <input type="text" class="container inline-block h-12 px-3 overflow-visible text-base font-semibold text-gray-700 bg-transparent border-2 border-gray-300 border-solid sm:max-w-xs lg:max-w-sm focus:outline-none cursor-text md:text-left focus:ring-2 focus:ring-indigo-500 focus:border-indigo-600 rounded-xl" placeholder="Your email address">
                <div class="flex items-center justify-center flex-shrink-0 h-12 px-4 py-2 text-white cursor-pointer bg-gradient-to-r from-indigo-600 to-indigo-700 rounded-xl">Request Access</div>
            </div>
        </div>
    </section>
